# Video Game Narrative Designer repository instructions

This repository contains one standalone C-Sweet protocol-v2 agent. Its purpose is:

> Owns world, story, characters, dialogue, narrative systems, and implementation specifications.

## Invariants

- Keep `com.csweet.video-game-narrative-designer` and version `2.1.1` synchronized between agent code,
...
```powershell
dotnet test
dotnet run --project src/CSweet.Agent.NarrativeDesigner.VideoGame -- --self-test
```
